...
<body>';
	...
	echo '
			...
			<tr id="upshrinkHeader"', empty($options['collapse_header']) ? '' : ' style="display: none;"', '>
				<td valign="top">
					<div class="headertitles" style="margin-right: 5px; position: relative;"> <strong>User Info</strong></div>
	...
	if (!empty($settings['enable_news']))
		echo '
					<div class="headertitles" style="width: 260px;"> <strong>Latest News</strong></div>
	...
	// The "key stats" box.
	echo '
					<div class="headertitles" style="width: 260px;"> <strong>Key Stats</strong></div>
		...
		<table cellspacing="0" cellpadding="3" border="0" align="center" width="100%">
			<tr>
				...
				<td valign="middle" align="center" style="white-space: nowrap;">
					', theme_copyright(), '<br />
					 <div class="smalltext"><a href="http://eternal-realm.net/index.php?action=downloads&amp;cat=smf">Dark Red Style</a> by Gaia
				</div></td>
